...
var server = fastify_1.default(options);
...
var instance = axios_1.default.create(axiosConfig);
...
server.get('/v1/databases', function (req, reply) { return __awaiter(void 0, void 0, void 0, function () {
    var results, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                _a.trys.push([0, 2, , 3]);
                console.log(req);
                return [4 /*yield*/, instance.get('https://api.notion.com/v1/databases')];
            case 1:
